...
export const projects = [
  ...
  },
  {
    ...
    detailImages: [project10Img1, project10Img2, project10Img3, project10Img4, project10Img5],
    fullDescription: "يهدف المشروع إلى تقديم خدمات استشارية للإشراف على مشروعات تشغيل وصيانة التشجير للشوارع والحدائق العامة بمكة المكرمة؛ بما يحافظ على مكانتها، ويرتقي بالمستوى الحضاري اللائق بها",
    location: "المدينة المنورة",
    area: "1300 م٢",
    completionDate: "2023",
    partner: logo7,
  ...
  },
  {
    ...
    detailImages: [project6Img1, project6Img2, project6Img3, project6Img4, project6Img5, project6Img6, project6Img7, project6Img8],
    fullDescription: "يهدف المشروع إلى تطوير المخطط الحضري والبنية التحتية لجميع منطقة مكة المكرمة من خلال تقديم خدمات هندسية استشارية للجنة التنفيذية للمخططات الخاصة والاستثمارية. يشمل المشروع اعتماد وتقييم أكثر من 60 مخططًا بمساحة تتجاوز 70 كم2، ومتابعة تنفيذ مشاريع الطرق والشوارع، ودراسة واعتماد التصاميم الهندسية، وإعداد التقارير الفنية اللازمة. كما يساهم المشروع في تحسين كفاءة الإجراءات وسرعة إنجاز المعاملات، من خلال إنشاء قاعدة بيانات متكاملة وتطبيق أحدث التقنيات في مجال نظم المعلومات الجغرافية",
    location: "المدينة المنورة",
    area: "1300 م٢",
    completionDate: "2023",
    partner: logo7,
  ...
  },
  {
    ...
    fullDescription: "روضة كهاتين – هي روضة اطفال نموذجية تقع بمدينة مكة المكرمة صممت علي معايير عالية حيث تم مراعاة الشكل و الوظيفة داخل و خارج المبني من حيث الخامات المستخدمة و الالوان المتنوعة لجذب انظار الاطفال و مستخدمين المبنى",
    location: "المدينة المنورة",
    area: "1300 م٢",
    completionDate: "2023",
    partner: logo10,
  ...
  },
  {
    ...
    date: "750 م",
    categories: ["تصميم عمراني", "تصميم معماري"],
    detailImages: [project11Img1, project11Img2, project11Img3, project11Img4, project11Img5, project11Img6],
    fullDescription: "عمارة حي ام الكتاد – هو مبني سكني خاص يقع بمدينة مكة المكرمة حي الملك فهد , تم تصميم المبني علي الطراز الحديث بحيث تم استخدام كتل معمارة متداخلة في تصميم المبني كما تم استخدام خامات ذات جمالية بصرية و استدامة في التصميم الخارجي للمبني .",
    location: "المدينة المنورة",
    area: "1300 م٢",
    completionDate: "2023",
    partner: logo7,
  ...
  },
  {
    ...
    fullDescription: "جامع العباس هو مسجد جامع يقع بحي التنعيم بمكة المكرمة – تم تصميمه علي الطراز الاسلامي الحديث حيث تم تبسيط المفردات المعمارية الاسلامية و استخدامها في واجهات المسجد بالكامل",
    location: "المدينة المنورة",
    area: "1300 م٢",
    completionDate: "2023",
    partner: logo8,
  ...
  },
  {
    ...
    detailImages: [project12Img1, project12Img2, project12Img3, project12Img4, project12Img5, project12Img6],
    fullDescription: "استهدف المشروع إعادة تأهيل حالة مسجد قباء والمباني المرافقة له، وتأهيل الأنظمة الحالية الخاصة به، من خلال تقييم الوضع الراهن وعمل المقترحات والتوصيات اللازمة، وإعداد التصميمات والمخططات الخاصة بعملية التطوير، ومن ثم الرسومات التفصيلية ومستندات الطرح اللازمة للتنفيذ",
    location: "المدينة المنورة",
    area: "1300 م٢",
    completionDate: "2023",
    partner: logo7,
  ...
  },
  {
    ...
    fullDescription: "يقع مشروع مجمع الطوارئ بمنطقة المشاعر المقدسة – مكة المكرمة حيث يعتبر مشروع مجمع الطوارئ من المشروعات الهامة والاستراتيجية؛ حيث يشتمل على ثلاث مناطق رئيسية لإدارة الازمات وقت الطوارئ وتشغل مساحة المجمع نحو 185 ألف م 2 حيث تم عمل : دراسات الوضع الراهن للمشروع. دراسات المخطط العام وبدائل الفكرة التصميمية للمخطط. إعداد التصميمات المعمارية والإنشائيةإعداد الرسومات التنفيذية للمخطط العام والمباني وإعداد كراسات الطرح على المقاولين.",
    location: "المدينة المنورة",
    area: "1300 م٢",
    completionDate: "2023",
    partner: logo9,
