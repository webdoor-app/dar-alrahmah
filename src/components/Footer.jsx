...
function Footer() {
  return (
    <footer className="relative h-[] bg-primaryBurnt text-white font-camel overflow-hidden">
      {/* Background Image */}
      ...
      <div className="relative md:w-full w- z-10 container w-fit justify-center items-center text-center mx-auto px-">
        <h3 className="font-sm py-4 text-gray-400 text-nowrap">
          سياسة الخصوصية
        ...
        <div className="flex justify-center mt-6 py-4">
          <div className="w-fit text-sm text-center">
